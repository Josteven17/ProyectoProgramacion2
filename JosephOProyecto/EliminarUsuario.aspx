<%@ Page Title="" Language="C#" MasterPageFile="~/MenuPrincipal.Master" AutoEventWireup="true" CodeBehind="EliminarUsuario.aspx.cs" Inherits="JosephOProyecto.EliminarUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:DropDownList ID="DIdUsuario" runat="server" DataSourceID="SqlUsuario" DataTextField="Email" DataValueField="IdUsuario"></asp:DropDownList>
