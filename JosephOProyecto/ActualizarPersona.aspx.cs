...
{
    public partial class ActualizarPersona : System.Web.UI.Page
    {
        ...
        protected void BActualizar_Click(object sender, EventArgs e)
        {
            ...
            {
                ClasePrincipal.SetIdConsulta(int.Parse(DActualizar.SelectedValue));
                GuardatDatosCP();
                ClasePrincipal.ActualizarPersona();
                ActualizarTabla();
            }
