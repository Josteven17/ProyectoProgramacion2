<%@ Page Title="" Language="C#" MasterPageFile="~/MenuPrincipal.Master" AutoEventWireup="true" CodeBehind="AgregarPersona.aspx.cs" Inherits="JosephOProyecto.AgregarPersona" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <asp:Button ID="BAgregarPersona" class="btn btn-primary rounded submit" runat="server" Text="Agregar" OnClick="BAgregarPersona_Click" />
